<%-- 
    Document   : aton
    Created on : Apr 20, 2024, 3:53:09 PM
    Author     : marxa
--%>
...
.left {
  ...
  animation-name: v-move;
    ...
    <body>
     ...
     <div class="container">
  <h1>Welcome Mr. Aton</h1>
  <p>Show them what you made</p>
  <div class="box-outer">
    <div class="main_box">
      ...
      <a href="https://aresmahfren.github.io/AboutMe/">
  ...
  <div class="box-outer">
    <div class="main_box">
      ...
      <div class="bar bottom"></div>
      <div class="bar left"></div>
      <a href="/midterm/AtonJavaButtons">
